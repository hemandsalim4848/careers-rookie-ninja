    ...
    <>
      ...
      {session && !isHR && (
        <Link
          ...
          className={`${styles.navLink} ${pathname.startsWith("/dashboard/seeker") ? styles.active : ""}`}
          onClick={() => setOpen(false)}
        >
          My Applications
        </Link>
      ...
      {isHR && (
        <>
          <Link
            href="/dashboard/hr"
            className={`${styles.navLink} ${pathname === "/dashboard/hr" ? styles.active : ""}`}
            onClick={() => setOpen(false)}
          >
            Dashboard
          </Link>
          <Link
            ...
            className={`${styles.navLink} ${pathname.startsWith("/dashboard/hr/jobs") ? styles.active : ""}`}
            onClick={() => setOpen(false)}
          >
            Manage Jobs
          </Link>
          <Link
            ...
            className={`${styles.navLink} ${pathname.startsWith("/dashboard/hr/applications") ? styles.active : ""}`}
            onClick={() => setOpen(false)}
          >
            Applicants
          </Link>
